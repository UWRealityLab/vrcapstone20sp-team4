...
public class ControllerCut : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //SliceObjects(Vector3.zero, new Vector3(1.0f, 0, 0));

    }
    void Update()
    {
        collision_cold_off += Time.deltaTime;
    }
       ...
       // Debug.Log("triggered");
        if (other.gameObject.tag == "Sliceable")
        {
            if (collision_cold_off > 0.2f)
            {
                ...
                SliceObjects(point, new Vector3(1, 0, 0));
